...
2. Plant SOS: upload a plant photo, describe symptoms, and receive likely causes, immediate care steps, what to avoid, and a reassessment window. UI and low-risk fallback checklist are now in place; Gemini route is next.
